...
# !!! Main.UserApp is configured as an alias for Main.Blog and you might encounter it in some tests
using Main.Blog, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Blog tests" begin
  @includetests ARGS
end
