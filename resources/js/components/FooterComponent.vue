      ...
      <div class="row">
        <div class="col-md-2">
          <span>
            ...
            <a target="_blank" href="https://imjo.in/3aZSG9">Buy me a coffee.</a>
          </span>
        </div>
        <div class="col-md-8">
          <p>Unless otherwise noted © 2015 - 2020, Vallabh Kansagara ( 56 52 4B 41 4E 53 41 47 41 52 41
            )</p>
        </div>
        <div class="col-md-2 pull-right">Execution time:</div>
      </div>
    </div>
  </footer>
</template>
